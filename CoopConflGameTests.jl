...
params = SimulationParameters(action0=0.1f0, norm0=2.3f0, ext_pun0=0.5f0, int_pun_ext0=0.0f0, int_pun_self0=0.0f0, population_size=50, group_size=10, relatedness=1.0)
population = population_construction(params)
